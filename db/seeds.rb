...
agnese = User.create!(first_name: "Agnese", last_name: "Costa", photo: "https://randomuser.me/api/portraits/women/61.jpg", email: "agnese@lewagon.com", password: "123456", qr: "")
...
luigi = User.create!(first_name: "Luigi", last_name: "Romano", photo: "https://randomuser.me/api/portraits/men/10.jpg", email: "luigi@lewagon.com", password: "123456", qr: "")
gemma = User.create!(first_name: "Gemma", last_name: "Nicoli", photo: "https://randomuser.me/api/portraits/women/17.jpg", email: "gemma@lewagon.com", password: "123456", qr: "")
...
shop2 = Shop.create!(name:"Gelateria da Mario", description:"Artisanal gelato. A place for those that want a fantastic Gelato in an elegant and friendly environment, during their lunch break or while taking a walk along the shopping streets of Milan. A welcoming place, to maintain a high profile, even when you are relaxing ", user: alessandro, photo: "https://images.unsplash.com/photo-1529688499411-262f191fe29e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=375&q=80", category: gelateria, address:"Via Mercato, 20, Milan")
...
shop4 = Shop.create!(name:"Gelateria Ambrogio", description:"Gelato made with love. A place for those that want a fantastic Gelato in an elegant and friendly environment, during their lunch break or while taking a walk along the shopping streets of Milan. A welcoming place, to maintain a high profile, even when you are relaxing", user: agnese, photo: "https://images.unsplash.com/photo-1501443762994-82bd5dace89a?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80", category: gelateria, address:"Via Spadari, 13, Milan")
...
shop19 = Shop.create!(name:"Barbershop Luigi", description:"Amazing deals on haircuts. We let you rediscover the rituals and the gestures of the traditional men’s grooming experience, from hot towel wet shave to scissors or razor haircut to manicure. Every service is carefully adapted to individual skin and hair type, making it a truly “tailor-made” Italian experience of understated luxury", user: gemma, photo: "https://images.unsplash.com/photo-1534778356534-d3d45b6df1da?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60", category: barbiere, address:"Via Bergognone, 1, Milan")
...
Card.create!(star_count: 4, status: "pending", shop_id: shop15.id, user_id: gemma.id)
Card.create!(star_count: 8, status: "pending", shop_id: shop6.id, user_id: gemma.id)
...
Promotion.create!(name: "2 for 1 gelato", description: "buy 1 gelato, get 2 stamps", shop_id: 11)
...
Promotion.create!(name: "10 percent off", description: "10 percent off any haircut or shave", shop_id: 2)
...
Promotion.create!(name: "2 for 1 joints", description: "1 joint, get 3 stamps", shop_id: 9)
